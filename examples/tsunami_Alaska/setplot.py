...
# --------------------------
    ...
    plotitem.imshow_cmin = 0.01
    #plotitem.imshow_cmax = 0.05   #when using inner product with forward problem
    plotitem.imshow_cmax = 0.02   #when using inner product with error
    plotitem.add_colorbar = False
    plotitem.amr_celledges_show = [0,0,0]
    plotitem.amr_patchedges_show = [0]
